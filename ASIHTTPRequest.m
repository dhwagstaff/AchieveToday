...
static NSTimeInterval defaultTimeOutSeconds = 90; //原10秒，统一修改为90秒超时
...
+ (void)initialize
{
	if (self == [ASIHTTPRequest class]) {
		...
		ASIAuthenticationError = [[NSError alloc] initWithDomain:NetworkRequestErrorDomain code:ASIAuthenticationErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"需要认证",NSLocalizedDescriptionKey,nil]];
		...
		ASIUnableToCreateRequestError = [[NSError alloc] initWithDomain:NetworkRequestErrorDomain code:ASIUnableToCreateRequestErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"无法创建请求(错误URL?)",NSLocalizedDescriptionKey,nil]];
		ASITooMuchRedirectionError = [[NSError alloc] initWithDomain:NetworkRequestErrorDomain code:ASITooMuchRedirectionErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"由于重定向多次而请求失败",NSLocalizedDescriptionKey,nil]];
        */
